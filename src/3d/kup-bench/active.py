...
agent
#%%
demos: list[Demo] = task_env.get_demos(1, live_demos=True)
demos
...
#%%
string = torch.load("all-models/reach-with-demos/rwd-Reach_Central-agent-policy:rnn_grasp_policy-cams:wrist+wrist_depth-policy:rnn_grasp_policy-rnn_opts:{'config': 'depth_feats', 'use_proprio': False}--_May29_12-29.pth")
...
agent.act(task_env.reset()[1], task_env)
#%%
