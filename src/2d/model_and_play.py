...
if __name__ == "__main__":
  ...
  model = AgentNetwork_Classification().train_on_behaviour(modelName = "agent-network-750.pth", data = data, overwriteDevice="cpu")
  # play_game(loadModelFromFile="./src/2d/models/agent-network-1k.pth")    
  # learn_game(n = 10)
  # play_game(loadModelFromFile="./src/2d/models/agent-network-1k.pth", modelType = AgentNetwork_Classification)
